            ...
            if (guild != null) {
                ...
                if(member != null) {
                    if (role != null) {
                        ...
                        Objects.requireNonNull(guild.getTextChannelById(simpleDiscordBridge.getConfigCommand().getGeneralTextChannel())).sendMessage(args[1] + " role was removed from " + args[0]).queue();
                        return true;
                    }
                }
            }
